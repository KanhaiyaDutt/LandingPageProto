...
  const agencies = [
    { name: "Indian National Centre for Ocean Information Services (INCOIS)", relevance: "The primary stakeholder for Tsunami and Ocean State Forecasts. Our platform directly supplements their warning systems.", phone: "+91-40-23895000", email: "director@incois.gov.in", website: "https://www.incois.gov.in/" },
    { name: "National Disaster Management Authority (NDMA)", relevance: "The apex body for disaster management in India. Our data integrates into their national situational awareness tools.", helpline: "1078 (Toll-Free)", email: "controlroom@ndma.gov.in", website: "https://ndma.gov.in/" },
    { name: "India Meteorological Department (IMD)", relevance: "The principal agency for weather forecasting. Our data helps validate their cyclone and storm surge forecasts.", phone: "+91-11-24611068", website: "https://mausam.imd.gov.in/" },
    { name: "Indian Coast Guard (ICG)", relevance: "A key first responder for maritime incidents. They can use our data to identify and rescue those in distress.", helpline: "1554 (Toll-Free)", website: "https://indiancoastguard.gov.in/" }
  ];
...
            fill="#e9e4ff" 
            fillOpacity="1"
            // CHANGED: New path for a different wave shape
