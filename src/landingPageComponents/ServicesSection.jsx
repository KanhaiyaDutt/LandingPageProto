...
const InteractiveServicesSection = () => {
  ...
  // Updated data with new theme colors for icons
  const servicesData = {
    citizens: {
  ...
  return (
    ...
    >
      <div className="relative z-10 container mx-auto max-w-6xl text-center">
        ...
        {/* Tab Buttons with updated light theme styling */}
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            // Changed content container to a light, clean card
            className="bg-white rounded-xl p-8 md:p-12 border border-gray-200 shadow-xl text-left"
          >
